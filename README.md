# 🎙️ RU→EN Transcriber — говори по-русски, получай английский текст

> **Главная фишка:** нажал Ctrl+Пробел → сказал фразу по-русски → в чат вставился грамотный английский текст в нужном стиле. Как будто ты native speaker.

Этот Python-скрипт работает в фоновом режиме и активируется глобальной горячей клавишей. Поддерживает два режима:
- **RU → EN (перевод):** распознаёт русскую речь и переводит на английский с выбранным стилем — идеально для англоязычных чатов, LinkedIn, Twitter
- **RU → RU (прямой):** просто расшифровка русской речи в текст

Использует OpenAI API для распознавания (STT) и стилизации. Настраивается через простой графический интерфейс: выбор модели, стиля, режима вывода.
